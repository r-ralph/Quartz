...
class Sub11Activity : AppCompatActivity() {
    ...
    private var required1: String? = null

    @Optional(setter = "setOptional1")
    private var optional1: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sub)
        Sub11ActivityIntentBuilder.restore(this)
    ...
    fun setRequired1(required1: String) {
        this.required1 = required1
    }

    fun setOptional1(optional1: String) {
